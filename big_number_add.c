...
int main(){
    char num_a[CNT] = "19283746564738291828374658492190203821743674268423148347343187";
    char num_b[CNT] = "6459673984658736478136478126129038124728952734589374823641782481";
    char num_a_[CNT];
    char num_b_[CNT];
...
// %0100s로 하면 화면에 아무것도 안뜸. sprintf의 결과는 끝에 NULL을 채우기 때문에 길이 초과
    ...
    for (i=sizeof(num_a_)-2; i>=0; i--){ //num_a의 최대 사이즈부터 천천히 내려감
